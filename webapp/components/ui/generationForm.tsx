...
const GenerationForm: FC<generationFormProps> = ({ }) => {
    ...
    async function fetchApi() {
        try {
            ...
            const baseUrl = 'https://263f-35-239-62-89.ngrok-free.app';
    ...
    return (
        <>
            <div onClick={async () => { await fetchApi() }} className="flex flex-col items-center w-full h-screen justify-center my-6 ">
